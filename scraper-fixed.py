...
# ---------------------------------------------------------
# 7. Rclone Upload
# ── CHANGE 1: sub_dir parameter added ──
# sub_dir = account/category folder (e.g. "mehranaslam45/posts")
# This creates proper folder structure on Mega:
#   vfx:/Batch--2026-xx-xx/mehranaslam45/posts/@author_caption_id/
#
